...
//        e.g https://github.com/Phoenix0303/events-app-api-server.git might become https://github.com/MyName/external.git
// variables:
    ...
    stages {
        stage('Get Source') {
            ...
            steps {
                ...
                git branch: 'main',
                    url: 'https://github.com/Phoenix0303/events-app-api-server.git'
